...
export const HomeScreen: React.FC<HomeScreenProps> = ({
  ...
  const displayExpiring = expiringProducts.length > 0 ? expiringProducts : products.slice(0, 2);
